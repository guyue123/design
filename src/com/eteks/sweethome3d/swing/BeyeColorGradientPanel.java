...
public class BeyeColorGradientPanel extends javax.swing.JPanel {
	...
	public BeyeColorGradientPanel() {
		this(DEFAULT_COLOR, DEFAULT_COLOR, GradientDirection.VERTICAL, false);
	}

	public BeyeColorGradientPanel(Color startColor, Color endColor) {
		this(startColor, endColor, GradientDirection.VERTICAL, false);
	}

	public BeyeColorGradientPanel(Color startColor, Color endColor, GradientDirection direction) {
		this(startColor, endColor, direction, false);
	}

	public BeyeColorGradientPanel(Color startColor, Color endColor, GradientDirection direction, boolean isTranslucent) {
	...
	public BeyeColorGradientPanel(BeyeColorGradientPanel other) {
